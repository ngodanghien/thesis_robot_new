...
msg = """
    ...
    -----------------------------------
    Node:
        * /UWB_Localizer_DWM1001C
    Published topics:
        * /dwm1001c/anchor3 [localizer_dwm1001/Anchor]
        * /dwm1001c/anchor2 [localizer_dwm1001/Anchor]
        * /dwm1001c/anchor1 [localizer_dwm1001/Anchor]
        * /dwm1001c/anchor0 [localizer_dwm1001/Anchor]
...
# initialize the node
rospy.init_node('UWB_Localizer_DWM1001C', anonymous=False)
...
serialPortDWM1001 = serial.Serial(
    ...
    port        = rospy.get_param('~serial_port_name','/dev/ttyUSB_UWB'), #'/dev/ttyACM0'
...
class dwm1001_localizer:
    ...
    def pubblishCoordinatesIntoTopics(self, networkDataArray):
        ...
        """
        #rospy.loginfo("[debug] pre FOR --: " + str(networkDataArray))
        # loop trough the array given by the serial port
        for network in networkDataArray:
            #TODO
            #rospy.loginfo("[debug] in FOR --: " + str(network))
            ...
            if 'AN' in network:
                try:
                    ...
                    pub_anchor = rospy.Publisher('/dwm1001c/anchor'+str(temp_anchor_number[-1]), Anchor, queue_size=1)
                ...
                try:
                    ...
                    # publish tag
                    pub_anchor = rospy.Publisher('/dwm1001c/tag', Tag, queue_size=1)
    ...
    def initializeDWM1001API(self):
        """
        Initialize dwm1001c api, by sending sending bytes
